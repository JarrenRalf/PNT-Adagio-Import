...
function createTriggers()
{
  ...
  ScriptApp.newTrigger('richmond_updateSearchData').timeBased().atHour(8).everyDays(1).create();
  ...
  ScriptApp.newTrigger('parksville_updateSearchData').timeBased().atHour(8).everyDays(1).create();
  ...
  ScriptApp.newTrigger('rupert_updateSearchData').timeBased().atHour(8).everyDays(1).create();
}